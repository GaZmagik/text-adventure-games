...
function d12Geometry(): { verts: number[][]; faces: number[][] } {
  ...
  const flat = [
    0, 8, 4, 0, 4, 14, 0, 14, 12, 0, 8, 10, 0, 10, 2, 0, 2, 16, 0, 12, 1, 0, 1, 17, 0, 17, 16, 1, 9, 5, 1, 5, 14, 1, 14,
    12, 1, 9, 11, 1, 11, 3, 1, 3, 17, 2, 10, 6, 2, 6, 15, 2, 15, 13, 2, 13, 3, 2, 3, 17, 2, 17, 16, 3, 11, 7, 3, 7, 15,
    3, 15, 13, 4, 8, 10, 4, 10, 6, 4, 6, 18, 4, 14, 5, 4, 5, 19, 4, 19, 18, 5, 9, 11, 5, 11, 7, 5, 7, 19, 6, 15, 7, 6,
    7, 19, 6, 19, 18,
  ];
  const faces: number[][] = [];
...
function getD4(): { verts: number[][]; faces: number[][] } {
  return (_d4 ??= d4Geometry());
}
function getD6(): { verts: number[][]; faces: number[][] } {
  return (_d6 ??= d6Geometry());
}
function getD8(): { verts: number[][]; faces: number[][] } {
  return (_d8 ??= d8Geometry());
}
function getD12(): { verts: number[][]; faces: number[][] } {
  return (_d12 ??= d12Geometry());
}
function getD20(): { verts: number[][]; faces: number[][] } {
  return (_d20 ??= d20Geometry());
}
function getD10(): { verts: number[][]; faces: number[][] } {
  return (_d10 ??= d10Geometry());
}

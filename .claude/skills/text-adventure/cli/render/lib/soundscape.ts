// SoundscapeEngine — Web Audio API atmosphere generator.
// Extracted from scene.ts for testability and SRP.
// Generates inline JS that defines the SoundscapeEngine prototype.

  ...
  return ok({
    ...
    workflow: {
      ...
      turnLoop: [
        ...
        { step: 3, name: 'Render', command: 'tag render scene --style <style>', description: 'Generate complete widget HTML with Shadow DOM, CDN CSS, JS, and interactive elements. Do not hand-alter the shell/runtime scaffolding.' },
        { step: 4, name: 'Compose', command: '(write narrative into #narrative or .scene-phase .narrative)', description: 'Write prose into the skeleton. Follow craftGuidance.proseChecklist and densityGuidance exactly.' },
  ...
  return ok({
    ...
    workflow: [
      ...
      },
      {
        ...
        description: 'Generates complete widget HTML. Keep the Shadow DOM shell, CDN links, JS, and panel/footer scaffolding intact. Compose only inside #narrative, .scene-phase .narrative, and the designated action/POI placeholders before verify.',
      },
      {
        step: 4,

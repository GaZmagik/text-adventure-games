...
```json tag-contract
{
  ...
  "kind": "style",
  "version": "1.4.0",
  "summary": "Cathedral-window style with jewel-tone panes, leaded borders, luminous gradients, and medieval manuscript warmth.",
  "mustRead": [
    "Pair with styles/style-reference.md for structural contracts.",
    "Use jewel tones as panes and accents while preserving contrast for text."
  ],
  "render": [
    "Panels should feel bounded by dark leading and lit from within.",
    "Best for fantasy, gothic horror, medieval, dungeon-crawl, and sacred mystery scenarios."
  ]
}
```
...
:host {
  ...
  --ta-font-heading:
    'Cinzel', 'EB Garamond', 'Palatino Linotype', 'Palatino', 'Book Antiqua', Georgia, 'Times New Roman', serif;
...
```css
.sg-pane--ruby {
  background-color: var(--sg-ruby-tint);
}
.sg-pane--sapphire {
